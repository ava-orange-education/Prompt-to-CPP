/**
 * @file    function_overloading_ai_fixed.cpp
 * @author  Vivek Bhadra
 *
 * @brief
 * Demonstrates function overloading with explicit overloads for common types
 * including string literals, avoiding reliance on implicit conversions.
 *
 * @license
