/**
 * @file    unit_converter_with_recursive.cpp
 * @author  Vivek Bhadra
 *
 * @brief
 * Implements a menu-driven unit converter supporting multiple conversions,
 * including a recursive variant for temperature conversion.
 *
 * @license
...
void displayMenu()
{
    ...
    std::cout << "3. Celsius to Fahrenheit (Iterative)\n";
