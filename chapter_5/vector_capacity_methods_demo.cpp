/**
 * @file    vector_capacity_methods_demo.cpp
 * @author  Vivek Bhadra
 *
 * @brief
 * Demonstrates std::vector capacity-related operations, including
 * reserve(), push_back(), and resize(), and highlights the difference
